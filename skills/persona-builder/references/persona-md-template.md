...
Use the verified-live path only if each handle/count was checked during this run via `mcp__claude_ai_pika__scrape_social` or another live supported source:
